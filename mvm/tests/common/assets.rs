...
pub fn block_module() -> ModuleTx {
    ModuleTx::new(
        include_bytes!("../assets/target/modules/1_Block.mv").to_vec(),
        CORE_CODE_ADDRESS,
    )
}
...
pub fn coins_module() -> ModuleTx {
    ModuleTx::new(
        include_bytes!("../assets/target/modules/2_Coins.mv").to_vec(),
        CORE_CODE_ADDRESS,
    )
}
...
pub fn event_module() -> ModuleTx {
    ModuleTx::new(
        include_bytes!("../assets/target/modules/7_Event.mv").to_vec(),
        CORE_CODE_ADDRESS,
    )
}
...
pub fn store_module() -> ModuleTx {
    ModuleTx::new(
        include_bytes!("../assets/target/modules/5_Store.mv").to_vec(),
        CORE_CODE_ADDRESS,
    )
}
...
pub fn time_module() -> ModuleTx {
    ModuleTx::new(
        include_bytes!("../assets/target/modules/6_Time.mv").to_vec(),
        CORE_CODE_ADDRESS,
    )
}
...
pub fn event_proxy_module() -> ModuleTx {
    ModuleTx::new(
        include_bytes!("../assets/target/modules/10_EventProxy.mv").to_vec(),
        CORE_CODE_ADDRESS,
    )
}
...
pub fn signer_module() -> ModuleTx {
    ModuleTx::new(
        include_bytes!("../assets/target/modules/4_Signer.mv").to_vec(),
        CORE_CODE_ADDRESS,
    )
}
...
pub fn pontem_module() -> ModuleTx {
    ModuleTx::new(
        include_bytes!("../assets/target/modules/8_Pontem.mv").to_vec(),
        CORE_CODE_ADDRESS,
    )
}
...
pub fn account_module() -> ModuleTx {
    ModuleTx::new(
        include_bytes!("../assets/target/modules/9_Account.mv").to_vec(),
        CORE_CODE_ADDRESS,
    )
}
...
pub fn abort_module() -> ModuleTx {
    ModuleTx::new(
        include_bytes!("../assets/target/modules/0_Abort.mv").to_vec(),
        CORE_CODE_ADDRESS,
    )
}
...
pub fn get_price_script(
    ...
    ScriptTx::new(
        include_bytes!("../assets/target/scripts/2_get_price_test.mv").to_vec(),
        vec![],
        vec![],
...
pub fn error_script(addr: AccountAddress) -> ScriptTx {
    ScriptTx::new(
        include_bytes!("../assets/target/scripts/1_error.mv").to_vec(),
        vec![],
        vec![],
        vec![addr],
    )
