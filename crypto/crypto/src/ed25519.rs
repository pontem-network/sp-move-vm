...
impl Ed25519PrivateKey {
    ...
    fn from_bytes_unchecked(
        bytes: &[u8],
    ) -> core::result::Result<Ed25519PrivateKey, CryptoMaterialError> {
...
impl Ed25519PublicKey {
    ...
    pub(crate) fn from_bytes_unchecked(
        bytes: &[u8],
    ) -> core::result::Result<Ed25519PublicKey, CryptoMaterialError> {
...
impl Ed25519Signature {
    ...
    pub(crate) fn from_bytes_unchecked(
        bytes: &[u8],
    ) -> core::result::Result<Ed25519Signature, CryptoMaterialError> {
    ...
    /// by a non-signer.
    pub fn check_malleability(bytes: &[u8]) -> core::result::Result<(), CryptoMaterialError> {
...
impl TryFrom<&[u8]> for Ed25519PrivateKey {
    ...
    fn try_from(bytes: &[u8]) -> core::result::Result<Ed25519PrivateKey, CryptoMaterialError> {
...
impl TryFrom<&[u8]> for Ed25519PublicKey {
    ...
    fn try_from(bytes: &[u8]) -> core::result::Result<Ed25519PublicKey, CryptoMaterialError> {
...
impl TryFrom<&[u8]> for Ed25519Signature {
    ...
    fn try_from(bytes: &[u8]) -> core::result::Result<Ed25519Signature, CryptoMaterialError> {
