...
fn test_address_bytes() {
    let hex = Vec::from_hex("ca843279e3427144cead5e4d5999a3d0ca843279e3427144cead5e4d5999a3d0")
...
fn test_address() {
    ...
    let hash_vec =
        &Vec::from_hex("81fdf1b3fe04abd62ada9adc8852fab3d1b145b875c259f017e697ea2f4da249")
            .expect("You must provide a valid Hex format");
